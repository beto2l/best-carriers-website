...
<section class="catalog" aria-labelledby="catalog-title"><h2 class="eyebrow" id="catalog-title">01 <span>Elige tu curso o servicio</span></h2><nav id="products" class="products" aria-label="Cursos y consultoría">${cards}</nav><p class="catalog-note">Precios en USD · Selecciona una opción</p></section>
...
<footer class="footer"><div class="methods"><img src="${escape(content.paymentMethodsImage)}" alt="Tarjetas American Express, Mastercard y Visa; Klarna y Cash App" width="398" height="116"><p>Apple Pay · Link · Afterpay · Amazon Pay</p><small>Stripe mostrará las opciones disponibles para tu compra.</small></div><p class="help">¿Necesitas ayuda? <a href="https://wa.me/12192396752?text=Necesito%20ayuda%20para%20inscribirme">Escríbenos</a></p><small class="copyright">© <span data-current-year>2026</span> Best Carriers</small></footer>
